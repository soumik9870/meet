...
export const DashboardUserButton = () => {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger className="rounded-lg border border-border/10 p-3 w-full flex justify-between items-center bg-white/5 hover:bg-white/10 overflow-hidden">
             {data.user.image ? (
                <Avatar>
